...
//
#ifndef AGPACK_V1_SBUFFER_HPP
#define AGPACK_V1_SBUFFER_HPP

#include "agpack/v1/sbuffer_decl.hpp"
...
class sbuffer {
public:
    sbuffer(size_t initsz = AGPACK_SBUFFER_INIT_SIZE):m_size(0), m_alloc(initsz)
    {
        if(initsz == 0) {
...
private:
    void expand_buffer(size_t len)
    {
        size_t nsize = (m_alloc > 0) ?
                m_alloc * 2 : AGPACK_SBUFFER_INIT_SIZE;
