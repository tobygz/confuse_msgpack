...
//
#ifndef AGPACK_V1_PACK_HPP
#define AGPACK_V1_PACK_HPP
...
public:
     ...
     * See https://github.com/agpack/agpack/blob/master/spec.md#formats-int
     *
     ...
     * See https://github.com/agpack/agpack/blob/master/spec.md#formats-float
     *
     * @param d a packing object.
     *
     * @return The reference of `*this`.
     ...
     * See https://github.com/agpack/agpack/blob/master/spec.md#formats-nil
     *
     * @return The reference of `*this`.
     */
     ...
     * See https://github.com/agpack/agpack/blob/master/spec.md#bool-format-family
     *
     * @return The reference of `*this`.
     */
     ...
     * You need to pack `n` agpack objects following this header and size.
     * See https://github.com/agpack/agpack/blob/master/spec.md#array-format-family
     *
     ...
     * You need to pack `n` pairs of agpack objects following this header and size.
     * See https://github.com/agpack/agpack/blob/master/spec.md#map-format-family
     *
     * @param n The number of array elements (array size).
     *
     * @return The reference of `*this`.
     ...
     * See https://github.com/agpack/agpack/blob/master/spec.md#formats-str
     *
     ...
     * See https://github.com/agpack/agpack/blob/master/spec.md#bin-format-family
     *
     * @param l The length of string.
     *
     * @return The reference of `*this`.
     ...
     * See https://github.com/agpack/agpack/blob/master/spec.md#formats-ext
     *
     * @param l The length of string.
     *
     * @return The reference of `*this`.
...
{
    char buf[3];
    buf[0] = static_cast<char>(0xcdu); _agpack_store16(&buf[1], d);
    append_buffer(buf, 3);
    return *this;
}
...
{
    char buf[5];
    buf[0] = static_cast<char>(0xceu); _agpack_store32(&buf[1], d);
    append_buffer(buf, 5);
    return *this;
}
...
{
    char buf[9];
    buf[0] = static_cast<char>(0xcfu); _agpack_store64(&buf[1], d);
    append_buffer(buf, 9);
    return *this;
}
...
{
    char buf[3];
    buf[0] = static_cast<char>(0xd1u); _agpack_store16(&buf[1], (uint16_t)d);
    append_buffer(buf, 3);
    return *this;
}
...
{
    char buf[5];
    buf[0] = static_cast<char>(0xd2u); _agpack_store32(&buf[1], (uint32_t)d);
    append_buffer(buf, 5);
    return *this;
}
...
{
    char buf[9];
    buf[0] = static_cast<char>(0xd3u); _agpack_store64(&buf[1], d);
    append_buffer(buf, 9);
    return *this;
}
...
inline packer<Stream>& packer<Stream>::pack_float(float d)
{
    ...
    mem.f = d;
    char buf[5];
    buf[0] = static_cast<char>(0xcau); _agpack_store32(&buf[1], mem.i);
    append_buffer(buf, 5);
    return *this;
}
...
inline packer<Stream>& packer<Stream>::pack_array(uint32_t n)
{
    if(n < 16) {
        ...
        char buf[3];
        buf[0] = static_cast<char>(0xdcu); _agpack_store16(&buf[1], static_cast<uint16_t>(n));
        append_buffer(buf, 3);
    } else {
        char buf[5];
        buf[0] = static_cast<char>(0xddu); _agpack_store32(&buf[1], static_cast<uint32_t>(n));
        append_buffer(buf, 5);
    }
    return *this;
}
...
inline packer<Stream>& packer<Stream>::pack_map(uint32_t n)
{
    if(n < 16) {
        ...
        char buf[3];
        buf[0] = static_cast<char>(0xdeu); _agpack_store16(&buf[1], static_cast<uint16_t>(n));
        append_buffer(buf, 3);
    } else {
        char buf[5];
        buf[0] = static_cast<char>(0xdfu); _agpack_store32(&buf[1], static_cast<uint32_t>(n));
        append_buffer(buf, 5);
    }
    return *this;
}
...
inline packer<Stream>& packer<Stream>::pack_str(uint32_t l)
{
    if(l < 32) {
        ...
        char buf[3];
        buf[0] = static_cast<char>(0xdau); _agpack_store16(&buf[1], static_cast<uint16_t>(l));
        append_buffer(buf, 3);
    } else {
        char buf[5];
        buf[0] = static_cast<char>(0xdbu); _agpack_store32(&buf[1], static_cast<uint32_t>(l));
        append_buffer(buf, 5);
    }
    return *this;
}
...
inline packer<Stream>& packer<Stream>::pack_bin(uint32_t l)
{
    if(l < 256) {
        ...
        char buf[3];
        buf[0] = static_cast<char>(0xc5u); _agpack_store16(&buf[1], static_cast<uint16_t>(l));
        append_buffer(buf, 3);
    } else {
        char buf[5];
        buf[0] = static_cast<char>(0xc6u); _agpack_store32(&buf[1], static_cast<uint32_t>(l));
        append_buffer(buf, 5);
    }
    return *this;
}
...
inline packer<Stream>& packer<Stream>::pack_ext(size_t l, int8_t type)
{
    ...
    default:
        if(l < 256) {
            ...
            _agpack_store16(&buf[1], static_cast<uint16_t>(l));
            buf[3] = static_cast<char>(type);
            append_buffer(buf, 4);
        } else {
            char buf[6];
            buf[0] = static_cast<char>(0xc9u);
            _agpack_store32(&buf[1], static_cast<uint32_t>(l));
...
inline void packer<Stream>::pack_imp_uint16(T d)
{
    if(d < (1<<7)) {
        ...
        /* unsigned 16 */
        char buf[3];
        buf[0] = static_cast<char>(0xcdu); _agpack_store16(&buf[1], static_cast<uint16_t>(d));
        append_buffer(buf, 3);
    }
}
...
inline void packer<Stream>::pack_imp_uint32(T d)
{
    if(d < (1<<8)) {
        ...
        if(d < (1<<16)) {
            ...
            /* unsigned 32 */
            char buf[5];
            buf[0] = static_cast<char>(0xceu); _agpack_store32(&buf[1], static_cast<uint32_t>(d));
            append_buffer(buf, 5);
        }
    }
}
...
inline void packer<Stream>::pack_imp_int16(T d)
{
    if(d < -(1<<5)) {
        if(d < -(1<<7)) {
            /* signed 16 */
            char buf[3];
            buf[0] = static_cast<char>(0xd1u); _agpack_store16(&buf[1], static_cast<int16_t>(d));
            append_buffer(buf, 3);
        } else {
            /* signed 8 */
...
inline void packer<Stream>::pack_imp_int32(T d)
{
    if(d < -(1<<5)) {
        if(d < -(1<<15)) {
            /* signed 32 */
            char buf[5];
            buf[0] = static_cast<char>(0xd2u); _agpack_store32(&buf[1], static_cast<int32_t>(d));
            append_buffer(buf, 5);
        } else if(d < -(1<<7)) {
            /* signed 16 */
            char buf[3];
