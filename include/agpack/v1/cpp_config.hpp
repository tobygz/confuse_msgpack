...
//
#ifndef AGPACK_V1_CPP_CONFIG_HPP
#define AGPACK_V1_CPP_CONFIG_HPP

#include "agpack/cpp_config_decl.hpp"
...
template<class T>
struct remove_cv {
    typedef typename agpack::remove_volatile<
        typename agpack::remove_const<T>::type
    >::type type;
};
...
#if defined(_MSC_VER)
#define AGPACK_DEPRECATED(msg) __declspec(deprecated(msg))
#else  // _MSC_VER 1914+ with /Zc:__cplusplus, @see https://docs.microsoft.com/cpp/build/reference/zc-cplusplus
#define AGPACK_DEPRECATED(msg) [[deprecated(msg)]]
#endif
#else  // __cplusplus >= 201402L
#define AGPACK_DEPRECATED(msg)
#endif // __cplusplus >= 201402L

#endif // AGPACK_V1_CPP_CONFIG_HPP
