...
//
#ifndef AGPACK_V1_TYPE_BOOST_AGPACK_VARIANT_HPP
#define AGPACK_V1_TYPE_BOOST_AGPACK_VARIANT_HPP
...
#include "agpack/adaptor/nil.hpp"
#include "agpack/adaptor/bool.hpp"
#include "agpack/adaptor/int.hpp"
#include "agpack/adaptor/float.hpp"
#include "agpack/adaptor/string.hpp"
#include "agpack/adaptor/vector_char.hpp"
#include "agpack/adaptor/raw.hpp"
#include "agpack/adaptor/ext.hpp"
#include "agpack/adaptor/vector.hpp"
#include "agpack/adaptor/map.hpp"
...
struct basic_variant :
    boost::variant<
        ...
        std::vector<char>, // BIN
        agpack::type::raw_ref, // BIN
        agpack::type::ext,               // EXT
        agpack::type::ext_ref,           // EXT
    ...
    bool is_nil() const {
        return boost::get<agpack::type::nil_t>(this) != AGPACK_NULLPTR;
    }
    bool is_bool() const {
        return boost::get<bool>(this) != AGPACK_NULLPTR;
    }
    bool is_int64_t() const {
        return boost::get<int64_t>(this) != AGPACK_NULLPTR;
    }
    bool is_uint64_t() const {
        return boost::get<uint64_t>(this) != AGPACK_NULLPTR;
    }
    bool is_double() const {
        return boost::get<double>(this) != AGPACK_NULLPTR;
    }
    bool is_string() const {
        return boost::get<std::string>(this) != AGPACK_NULLPTR;
    }
#if (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
    bool is_boost_string_ref() const {
        return boost::get<boost::string_ref>(this) != AGPACK_NULLPTR;
    }
#endif // (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
    bool is_vector_char() const {
        return boost::get<std::vector<char> >(this) != AGPACK_NULLPTR;
    }
    bool is_vector_char() {
        return boost::get<std::vector<char> >(this) != AGPACK_NULLPTR;
    }
    bool is_raw_ref() const {
        return boost::get<raw_ref>(this) != AGPACK_NULLPTR;
    }
    bool is_ext() const {
        return boost::get<ext>(this) != AGPACK_NULLPTR;
    }
    bool is_ext_ref() const {
        return boost::get<ext_ref>(this) != AGPACK_NULLPTR;
    }
    bool is_vector() const {
        return boost::get<std::vector<basic_variant<STR, BIN, EXT> > >(this) != AGPACK_NULLPTR;
    }
    bool is_map() const {
        return boost::get<std::map<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT> > >(this) != AGPACK_NULLPTR;
    }
    bool is_multimap() const {
        return boost::get<std::multimap<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT> > >(this) != AGPACK_NULLPTR;
    }
...
struct as<type::basic_variant<STR, BIN, EXT> > {
    type::basic_variant<STR, BIN, EXT> operator()(agpack::object const& o) const {
        switch(o.type) {
        case type::NIL:
            return o.as<agpack::type::nil_t>();
        case type::BOOLEAN:
            return o.as<bool>();
...
struct pack<type::basic_variant<STR, BIN, EXT> > {
    template <typename Stream>
    agpack::packer<Stream>& operator()(agpack::packer<Stream>& o, const type::basic_variant<STR, BIN, EXT>& v) const {
...
struct object_imp : boost::static_visitor<void> {
    void operator()(agpack::type::nil_t const& v) const {
        object<agpack::type::nil_t>()(o_, v);
    }
    ...
    object_imp(agpack::object& o):o_(o) {}
    agpack::object& o_;
};
...
struct object<type::basic_variant<STR, BIN, EXT> > {
    void operator()(agpack::object& o, const type::basic_variant<STR, BIN, EXT>& v) const {
...
struct object_with_zone_imp : boost::static_visitor<void> {
    ...
    object_with_zone_imp(agpack::object::with_zone& o):o_(o) {}
    agpack::object::with_zone& o_;
};
...
struct object_with_zone<type::basic_variant<STR, BIN, EXT> > {
    void operator()(agpack::object::with_zone& o, const type::basic_variant<STR, BIN, EXT>& v) const {
...
#endif // AGPACK_V1_TYPE_BOOST_AGPACK_VARIANT_HPP
