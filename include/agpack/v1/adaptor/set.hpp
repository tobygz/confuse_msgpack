...
//
#ifndef AGPACK_V1_TYPE_SET_HPP
#define AGPACK_V1_TYPE_SET_HPP
...
struct as<std::set<T, Compare, Alloc>, typename std::enable_if<agpack::has_as<T>::value>::type> {
    std::set<T, Compare, Alloc> operator()(agpack::object const& o) const {
...
struct convert<std::set<T, Compare, Alloc> > {
    agpack::object const& operator()(agpack::object const& o, std::set<T, Compare, Alloc>& v) const {
        if (o.type != agpack::type::ARRAY) { throw agpack::type_error(); }
        agpack::object* p = o.via.array.ptr + o.via.array.size;
        agpack::object* const pbegin = o.via.array.ptr;
...
struct pack<std::set<T, Compare, Alloc> > {
    ...
    agpack::packer<Stream>& operator()(agpack::packer<Stream>& o, const std::set<T, Compare, Alloc>& v) const {
...
struct object_with_zone<std::set<T, Compare, Alloc> > {
    void operator()(agpack::object::with_zone& o, const std::set<T, Compare, Alloc>& v) const {
...
template <typename T, typename Compare, typename Alloc>
struct as<std::multiset<T, Compare, Alloc>, typename std::enable_if<agpack::has_as<T>::value>::type> {
    std::multiset<T, Compare, Alloc> operator()(agpack::object const& o) const {
        if (o.type != agpack::type::ARRAY) { throw agpack::type_error(); }
        agpack::object* p = o.via.array.ptr + o.via.array.size;
        agpack::object* const pbegin = o.via.array.ptr;
...
struct convert<std::multiset<T, Compare, Alloc> > {
    agpack::object const& operator()(agpack::object const& o, std::multiset<T, Compare, Alloc>& v) const {
        if (o.type != agpack::type::ARRAY) { throw agpack::type_error(); }
        agpack::object* p = o.via.array.ptr + o.via.array.size;
        agpack::object* const pbegin = o.via.array.ptr;
...
struct pack<std::multiset<T, Compare, Alloc> > {
    template <typename Stream>
    agpack::packer<Stream>& operator()(agpack::packer<Stream>& o, const std::multiset<T, Compare, Alloc>& v) const {
        uint32_t size = checked_get_container_size(v.size());
        o.pack_array(size);
...
struct object_with_zone<std::multiset<T, Compare, Alloc> > {
    void operator()(agpack::object::with_zone& o, const std::multiset<T, Compare, Alloc>& v) const {
        o.type = agpack::type::ARRAY;
        if (v.empty()) {
            o.via.array.ptr = AGPACK_NULLPTR;
            o.via.array.size = 0;
