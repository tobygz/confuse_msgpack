...
//
#ifndef AGPACK_V1_TYPE_CPP11_ARRAY_UNSIGNED_CHAR_HPP
#define AGPACK_V1_TYPE_CPP11_ARRAY_UNSIGNED_CHAR_HPP
...
struct convert<std::array<unsigned char, N>> {
    agpack::object const& operator()(agpack::object const& o, std::array<unsigned char, N>& v) const {
        switch (o.type) {
...
struct convert<std::array<unsigned char, 0>> {
    agpack::object const& operator()(agpack::object const& o, std::array<unsigned char, 0>&) const {
        return o;
    }
};
...
struct pack<std::array<unsigned char, N>> {
    ...
    agpack::packer<Stream>& operator()(agpack::packer<Stream>& o, const std::array<unsigned char, N>& v) const {
...
struct object<std::array<unsigned char, N>> {
    void operator()(agpack::object& o, const std::array<unsigned char, N>& v) const {
        uint32_t size = checked_get_container_size(v.size());
...
struct object_with_zone<std::array<unsigned char, N>> {
    void operator()(agpack::object::with_zone& o, const std::array<unsigned char, N>& v) const {
        uint32_t size = checked_get_container_size(v.size());
        o.type = agpack::type::BIN;
...
#endif // AGPACK_V1_TYPE_CPP11_ARRAY_UNSIGNED_CHAR_HPP
