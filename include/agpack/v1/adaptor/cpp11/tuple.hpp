...
//
#ifndef AGPACK_V1_TYPE_CPP11_TUPLE_HPP
#define AGPACK_V1_TYPE_CPP11_TUPLE_HPP
...
struct StdTupleAsImpl {
    static std::tuple<T, Args...> as(agpack::object const& o) {
...
template <typename... Args>
struct StdTupleAs {
    static std::tuple<Args...> as(agpack::object const& o) {
...
template <>
struct StdTupleAs<> {
    static std::tuple<> as (agpack::object const&) {
        return std::tuple<>();
    }
};
...
template <typename... Args>
struct as<std::tuple<Args...>, typename std::enable_if<agpack::any_of<agpack::has_as, Args...>::value>::type>  {
...
struct StdTupleToObjectWithZone {
    static void convert(
        ...
        o.via.array.ptr[N-1] = agpack::object(std::get<N-1>(v), o.zone);
    }
};
...
#endif // AGPACK_V1_TYPE_CPP11_TUPLE_HPP
