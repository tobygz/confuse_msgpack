...
//
#ifndef AGPACK_V1_TYPE_CPP11_UNORDERED_SET_HPP
#define AGPACK_V1_TYPE_CPP11_UNORDERED_SET_HPP
...
struct as<std::unordered_set<Key, Hash, Compare, Alloc>, typename std::enable_if<agpack::has_as<Key>::value>::type> {
    std::unordered_set<Key, Hash, Compare, Alloc> operator()(agpack::object const& o) const {
...
struct convert<std::unordered_set<Key, Hash, Compare, Alloc>> {
    agpack::object const& operator()(agpack::object const& o, std::unordered_set<Key, Hash, Compare, Alloc>& v) const {
        if(o.type != agpack::type::ARRAY) { throw agpack::type_error(); }
        agpack::object* p = o.via.array.ptr + o.via.array.size;
        agpack::object* const pbegin = o.via.array.ptr;
...
struct pack<std::unordered_set<Key, Hash, Compare, Alloc>> {
    template <typename Stream>
        agpack::packer<Stream>& operator()(agpack::packer<Stream>& o, const std::unordered_set<Key, Hash, Compare, Alloc>& v) const {
...
struct object_with_zone<std::unordered_set<Key, Hash, Compare, Alloc>> {
    void operator()(agpack::object::with_zone& o, const std::unordered_set<Key, Hash, Compare, Alloc>& v) const {
...
template <typename Key, typename Hash, typename Compare, typename Alloc>
struct as<std::unordered_multiset<Key, Hash, Compare, Alloc>, typename std::enable_if<agpack::has_as<Key>::value>::type> {
    std::unordered_multiset<Key, Hash, Compare, Alloc> operator()(agpack::object const& o) const {
        if (o.type != agpack::type::ARRAY) { throw agpack::type_error(); }
        agpack::object* p = o.via.array.ptr + o.via.array.size;
        agpack::object* const pbegin = o.via.array.ptr;
...
struct convert<std::unordered_multiset<Key, Hash, Compare, Alloc>> {
    agpack::object const& operator()(agpack::object const& o, std::unordered_multiset<Key, Hash, Compare, Alloc>& v) const {
        if(o.type != agpack::type::ARRAY) { throw agpack::type_error(); }
        agpack::object* p = o.via.array.ptr + o.via.array.size;
        agpack::object* const pbegin = o.via.array.ptr;
...
struct pack<std::unordered_multiset<Key, Hash, Compare, Alloc>> {
    template <typename Stream>
        agpack::packer<Stream>& operator()(agpack::packer<Stream>& o, const std::unordered_multiset<Key, Hash, Compare, Alloc>& v) const {
        uint32_t size = checked_get_container_size(v.size());
        o.pack_array(size);
...
struct object_with_zone<std::unordered_multiset<Key, Hash, Compare, Alloc>> {
    void operator()(agpack::object::with_zone& o, const std::unordered_multiset<Key, Hash, Compare, Alloc>& v) const {
        o.type = agpack::type::ARRAY;
        if(v.empty()) {
            o.via.array.ptr = AGPACK_NULLPTR;
            o.via.array.size = 0;
...
#endif // AGPACK_V1_TYPE_CPP11_UNORDERED_SET_HPP
