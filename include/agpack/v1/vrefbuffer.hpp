...
//
#ifndef AGPACK_V1_VREFBUFFER_HPP
#define AGPACK_V1_VREFBUFFER_HPP

#include "agpack/v1/vrefbuffer_decl.hpp"
...
public:
    vrefbuffer(size_t ref_size = AGPACK_VREFBUFFER_REF_SIZE,
               size_t chunk_size = AGPACK_VREFBUFFER_CHUNK_SIZE)
...
#endif // AGPACK_V1_VREFBUFFER_HPP
