...
//
#ifndef AGPACK_V3_UNPACK_DECL_HPP
#define AGPACK_V3_UNPACK_DECL_HPP

#include "agpack/v2/unpack_decl.hpp"
...
agpack::object_handle unpack(
    ...
    agpack::unpack_reference_func f = AGPACK_NULLPTR, void* user_data = AGPACK_NULLPTR, agpack::unpack_limit const& limit = unpack_limit());
...
#endif // AGPACK_V3_UNPACK_DECL_HPP
