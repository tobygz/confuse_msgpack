...
#ifndef AGPACK_PREDEF_VERSION_NUMBER_H
#define AGPACK_PREDEF_VERSION_NUMBER_H

/*`
[heading `AGPACK_VERSION_NUMBER`]

``
AGPACK_VERSION_NUMBER(major,minor,patch)
``
...
*/
#define AGPACK_VERSION_NUMBER(major,minor,patch) \
    ( (((major)%100)*10000000) + (((minor)%100)*100000) + ((patch)%100000) )

#define AGPACK_VERSION_NUMBER_MAX \
    AGPACK_VERSION_NUMBER(99,99,99999)

#define AGPACK_VERSION_NUMBER_ZERO \
    AGPACK_VERSION_NUMBER(0,0,0)

#define AGPACK_VERSION_NUMBER_MIN \
    AGPACK_VERSION_NUMBER(0,0,1)

#define AGPACK_VERSION_NUMBER_AVAILABLE \
    AGPACK_VERSION_NUMBER_MIN

#define AGPACK_VERSION_NUMBER_NOT_AVAILABLE \
    AGPACK_VERSION_NUMBER_ZERO

/*`
``
AGPACK_VERSION_NUMBER_MAJOR(N), AGPACK_VERSION_NUMBER_MINOR(N), AGPACK_VERSION_NUMBER_PATCH(N)
``
...
respectively.
*/
#define AGPACK_VERSION_NUMBER_MAJOR(N) \
    ( ((N)/10000000)%100 )

#define AGPACK_VERSION_NUMBER_MINOR(N) \
    ( ((N)/100000)%100 )

#define AGPACK_VERSION_NUMBER_PATCH(N) \
    ( (N)%100000 )
