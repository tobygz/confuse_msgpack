...
#include "adaptor/agpack_tuple.hpp"
...
#if AGPACK_HAS_INCLUDE(<optional>)
#include "adaptor/cpp17/optional.hpp"
#endif // AGPACK_HAS_INCLUDE(<optional>)

#if AGPACK_HAS_INCLUDE(<string_view>)
#include "adaptor/cpp17/string_view.hpp"
#endif // AGPACK_HAS_INCLUDE(<string_view>)
